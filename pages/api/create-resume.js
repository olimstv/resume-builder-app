...
const apiCreateResume = withSession(async function (req, res) {
  ...
  try {
    ...
    newResume.subprofile.basics.label = currentUserProfile.basics.label[0]
    newResume.subprofile.basics.summary = currentUserProfile.basics.summary[0]
    debugger;
    console.log('test', newResume.subprofile.basics.summary)
